# Generated by Django 2.2 on 2021-05-11 00:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employeeZoo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employeeZoo', to='officalZooApp.Zoo')),
            ],
        ),
        migrations.CreateModel(
            name='Animal',
            fields=[
                ...
                ('animalZoo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='animalZoo', to='officalZooApp.Zoo')),
            ],
        ),
    ]
